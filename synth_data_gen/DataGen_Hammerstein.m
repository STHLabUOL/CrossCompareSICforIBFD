% Modified/Extended Script.
% Add tx_PSDU export. In case data is intended as SOI, disable PA-NL
% and don't add AWGN.
% Also, SNR (here SINR) set to 62dB for noise at -77dBm
...
flags.varSI = 0;        % 0 - 'invSI', 1 (or otherwise) - 'varSI'
...
% Customize some default parameters
parSigs.SINR_dB_awgn = 62;  % assuming -15dB power in y_H, aim for -77dB noise power (-90dBm/MHz @ 20MHz)
cfgHT.MCS = 2; %2: QPSK/4QAM, 
    ...
    for idx_file = 0:(NumFiles-1)
        ...
        if flags.save_mat
            ...
            save([folders.data '/' folders.dataset '/' datasets_str{idx_datasets} '/' filename], ...
                ...
                'parSigs','tgnChan_info', 'parChanSI', 'tx_PSDU');
        end; fprintf('\n');
