...
for idx_datasets=1:length(datasets_str)
    ...
    while 1
        ...
        if abs(parLowNoiAmpl.parAmpOut.SISDR_OutIn_dB-parAmpIn.SISDR_dB_desired) < 1 % desiredDelta was "1" before, but needs to be zero above for truly non-variable NL
